...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { CLK20MHZ }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { ACK_out }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
